...
def login():
    if request.method == "POST":
        ...
        usuario = crud_usuario.find("email", email)
...
def registrar():
    ...
    if request.method == "POST":
        ...
        crud_usuario.create({"nome": nome, "email": email, "senha": criar_senha(senha), "id_perfil": id_perfil})
...
def mudar_senha():
    if request.method == "POST":
        ...
        usuario = crud_usuario.find("id", current_user.id)
        ...
        crud_usuario.update(usuario.id, {"senha": criar_senha(nova_senha)})
